                        ...
                        <table style="width: 100%; border-radius: 12px; background-color: #fff; padding-left: 32px; padding-right: 32px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" cellpadding="0" cellspacing="0" role="presentation">
                          ...
                          <tr>
                            <td style="padding-top: 12px; padding-bottom: 12px; text-align: center">
                              <p style="margin: 0 0 12px; font-size: 30px; line-height: 24px">Hi <span style="margin: 0 0 12px; font-size: 30px; font-weight: 600; line-height: 24px">Narasimma</span></p>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <table class="sm-w-full" align="center" style="width: 400px; border-radius: 8px; background-color: #fee2e2" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                  <td>
                                    <table align="center" style="width: 250px; padding: 12px; line-height: 4px" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                        <td style="width: 8.333333%">
                                          <img src="https://static.vecteezy.com/system/resources/previews/006/988/723/original/boy-playing-game-gamer-logo-free-vector.jpg" alt style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0; height: 64px; width: 64px; border-radius: 9999px;">
                                        </td>
                                        <td style="margin-left: 20px; width: 25%">
                                          <p style="margin: 0 0 12px; text-align: center; font-size: 20px; font-weight: 600; line-height: 24px">Simma</p>
                                          <p style="margin: 0; text-align: center; font-size: 14px; color: #334155">Lead Developer</p>
                                        </td>
                                      </tr>
                                    </table>
                                    <table class="sm-w-250px" align="center" style="width: 300px; line-height: 12px" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                        <td style="width: 25%;">
                                          <p style="font-size: 14px; color: #334155;">From</p>
                                          <p style="font-size: 14px; font-weight: 600;">30/07/2023</p>
                                        </td>
                                        <td style="width: 25%;">
                                          <p style="text-align: center;">-</p>
                                        </td>
                                        <td style="width: 25%;">
                                          <p style="font-size: 14px; color: #334155;">To</p>
                                          <p style="font-size: 14px; font-weight: 600;"> 30/07/2023</p>
                                        </td>
                                      </tr>
                                    </table>
                                    <table style="margin-left: 24px; margin-right: 24px; width: 200px" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                        <td>
                                          <p style="margin: 0 0 24px; font-size: 14px; font-weight: 600">Smmaa</p>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
